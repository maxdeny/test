	...
	public void dataLoad(int[] types) {
       ...
       if(types==null){
		this.loadData(new Updateone[] { 
			    new Updateone("v3_index",new String[][] { { "version", "android" } }),
...
//					moveNext();
			...
			Msg_ModuleList.Builder builder = (Msg_ModuleList.Builder) son.build;
			F.ModuleList=builder;
			dataLoad();
			}
