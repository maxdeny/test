...
//import com.wjwl.mobile.taocz.act.CookingStyleSelectAct.Eatpurpose;
//import com.wjwl.mobile.taocz.act.CookingStyleSelectAct.MyAdapter;
//
//public class CookingStyleSelect1Act extends MActivity {
//
...
//		else
//			mData.clear();
//		for (int i = 0; i < F.FOODCATEGORY.getComment(id1).getCommentCount(); i++) {
//			Map<String, Object> map = new HashMap<String, Object>();
//			map.put("title", F.FOODCATEGORY.getComment(id1).getComment(i)
//					.getCommentcontent());
//			map.put("id2", F.FOODCATEGORY.getComment(id1).getComment(i)
//					.getCommentid());
//			mData.add(map);
//		}
...
//									"" + (String) mData.get(position).get("id2"));
...
//		// Msg_Maddresslist.Builder builder = (Msg_Maddresslist.Builder)
//		// son.build;
...
//		// Map<String, Object> map = new HashMap<String, Object>();
//		//
//		// map.put("childareaid", addresslist.get(i).getChildareaid());
//		// mData.add(map);
//		// }
//		// madapter = new MyAdapter(this);
