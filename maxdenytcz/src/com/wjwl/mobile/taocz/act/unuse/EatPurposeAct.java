...
//
//public class EatPurposeAct extends MActivity {
...
//		else
//			mData.clear();
//		for (int i = 0; i < F.PURPOSECATEGORY.getCommentList().size(); i++) {
//			Map<String, Object> map = new HashMap<String, Object>();
//			map.put("areaid", F.PURPOSECATEGORY.getComment(i).getCommentid());
//			map.put("title", F.PURPOSECATEGORY.getComment(i).getCommentcontent());
//			mData.add(map);
//		}
...
//						i.setClass(EatPurposeAct.this,
//								EatPurposeSecondAct.class);
//						startActivity(i);
//						EatPurposeAct.this.finish();
//					}
//				});
//			} catch (Exception e) {
//				e.printStackTrace();
