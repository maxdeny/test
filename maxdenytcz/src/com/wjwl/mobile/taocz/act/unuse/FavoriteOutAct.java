...
//
//public class FavoriteOutAct extends MActivity {
//
...
//		if (son != null && son.mgetmethod.equals("MFAVORITE")) {
...
//			listview.setAdapter(new FavoriteListAdapter(FavoriteOutAct.this,
//					list));
//		}
//		prv.refreshComplete();
//	}
...
//				new String[][] { { "categoryid", "3" }, { "username", "zk" } },
