...
public class MyCouponUnuselistAct extends MActivity {
	TextView norows;
	PullReloadView prv;
	PageListView lv;
	CouponAdapter adp;
	...
	public void disposeMessage(Son son) throws Exception {
		if (son.build == null && son.mgetmethod.equals("v3_couponlist")) {
			...
			adp = new CouponAdapter(MyCouponUnuselistAct.this, mData);
			lv.setAdapter(adp);
		}
		prv.refreshComplete();
	}
	...
	public void dataLoad(int[] types) {
		if (types == null) {
			this.loadData(new Updateone[] { new Updateone("V3_COUPONLIST",
					new String[][] { { "type", "1" }, { "uid", F.USER_ID } }), });
		}
	}
}
