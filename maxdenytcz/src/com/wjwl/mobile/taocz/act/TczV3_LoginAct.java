...
public class TczV3_LoginAct extends MActivity {
	...
	CheckBox chk;
	LinearLayout login_qq, login_sina;
	Button bt_login;
	...
	protected void create(Bundle arg0) {
		...
		login_qq = (LinearLayout) findViewById(R.id.ll_qq);
		login_sina = (LinearLayout) findViewById(R.id.ll_sina);
		...
		getPassWord.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent();
				i.putExtra("id",
						"http://m.taocz.com/index.php?app=member.member&act=findpwd");
				i.putExtra("actfrom", "TczV3_LoginAct");
				i.setClass(TczV3_LoginAct.this, ZTWebViewAct.class);
				startActivity(i);
			}
		});
		...
		headlayout.setTitle("账户");
		headlayout.setRightButton3Text("注册");
		headlayout.setRightButton3Click(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent();
				i.setClass(TczV3_LoginAct.this, TczV3_RegistStep1Act.class);
				startActivity(i);
			}
		});
		usm = (EditText) findViewById(R.id.et_username);
		...
		userdb = new SQLDB(TczV3_LoginAct.this);
		getUserInfo();
		bt_login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (username.length() <= 0) {
					Toast toast = Toast.makeText(TczV3_LoginAct.this, "请输入用户名",
							Toast.LENGTH_SHORT);
					toast.show();
					usm.requestFocus();
					return;
				} else if (username.length() > 20) {
					Toast toast = Toast.makeText(TczV3_LoginAct.this,
				...
				if (password.length() <= 0) {
					Toast toast = Toast.makeText(TczV3_LoginAct.this, "请输入密码",
							Toast.LENGTH_SHORT);
					toast.show();
					pwd.requestFocus();
					return;
					...
					Toast toast = Toast.makeText(TczV3_LoginAct.this,
							"输入密码有误，请重新输入", Toast.LENGTH_SHORT);
					toast.show();
					pwd.requestFocus();
					return;
				}
		...
		login_qq.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mTencent = Tencent.createInstance(APP_ID, TczV3_LoginAct.this);
				mHandler = new Handler();
				mProgressDialog = new ProgressDialog(TczV3_LoginAct.this);
				...
				if (!mTencent.isSessionValid()) {
					...
					mTencent.login(TczV3_LoginAct.this, SCOPE, listener);
				} else {
					mTencent.logout(TczV3_LoginAct.this);
				}
			}
		});
		login_sina.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				wherelogin = "2";
				mWeibo.authorize(TczV3_LoginAct.this, new AuthDialogListener());
			}
		});
	...
	class AuthDialogListener implements WeiboAuthListener {
		...
		public void onComplete(Bundle values) {
			...
			TczV3_LoginAct.accessToken = new Oauth2AccessToken(token,
					expires_in);
			if (TczV3_LoginAct.accessToken.isSessionValid()) {
				...
				AccessTokenKeeper.keepAccessToken(TczV3_LoginAct.this,
						accessToken);
				Toast.makeText(TczV3_LoginAct.this, "认证成功", Toast.LENGTH_SHORT)
						.show();
				dataLoad(new int[] { 3 });
			}
		}
