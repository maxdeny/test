...
public class Arith {
	...
	public static String encrypt(String seed, String cleartext)throws Exception {// 加密
	...
	public static String decrypt(String seed, String encrypted)throws Exception {// 解密
	byte[] rawKey = getRawKey(seed.getBytes());
