...
public class Item_RanqiList extends LinearLayout {
	...
	public Item_RanqiList(Context context) {
		super(context);
		initview();

	}

	public Item_RanqiList(Context context, AttributeSet attrs) {
		super(context, attrs);
		initview();
	}
	...
	void initview() {
		...
		flater.inflate(R.layout.item_shoppinglist1, this);
