...
import com.wjwl.mobile.taocz.act.JyTjOrderInfoAct;
...
public class JyTjOrderIteam extends LinearLayout {
	TextView name,date,ordernumber,numbers,who,money,phone,state;
	LinearLayout linear;
	String order_num;
	public JyTjOrderIteam(Context context) {
		super(context);
	...
	public void init(){
		...
		View v=f.inflate(R.layout.jytjorderitem, this);
		...
		linear.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
						Intent i=new Intent(getContext(),JyTjOrderInfoAct.class);
