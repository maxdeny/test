...
public class GroupBuyItem extends LinearLayout {
...
//		View view = flater.inflate(R.layout.groupbuyitem, this);
		View view = flater.inflate(R.layout.groupbuyitem, this);
		newprice = (TextView) findViewById(R.groupbuyitem.price);
		oldprice = (TextView) findViewById(R.groupbuyitem.yprice);
		businessname = (TextView) findViewById(R.groupbuyitem.contents);
		buynum = (TextView) findViewById(R.groupbuyitem.number);
		businessaddress = (TextView) findViewById(R.groupbuyitem.place);
		productimg = (MImageView) findViewById(R.groupbuyitem.img);
//		name=(TextView) findViewById(R.groupbuyitem.name);
//		yishou=(TextView) findViewById(R.groupbuyitem.yishou);
		...
		newproduct = (ImageView) findViewById(R.groupbuyitem.newproduct);
		mianyuyue = (ImageView) findViewById(R.groupbuyitem.mianyuyue);
		clic_view = (View) findViewById(R.groupbuyitem.linear);
...
//	}
	...
	public void setData(String p, String y, String c, String n, String a,
			String id) {
		newprice.setText("￥" + p);
		oldprice.setText("￥" + y);
		businessname.setText(c);
		buynum.setText("已有" + n + "人购买");
		businessaddress.setText(a);
		productId = id;
	}
