...
public class V3_Item_Search extends LinearLayout implements OnClickListener,
RecognizerDialogListener  {
	...
	public V3_Item_Search(Context context, AttributeSet attrs) {
		super(context, attrs);
		initview();
	}
	...
	void initview() {
		...
		flater.inflate(R.layout.v3_item_search, this);
		taoicon=(View) findViewById(R.v3_item_search.title);
		popublayout = (V3_PopubLayout) findViewById(R.v3_item_search.popublayout);
		edit_search = (EditText) findViewById(R.v3_item_search.edit_search);
		speakButton = (Button) findViewById(R.v3_item_search.speakbutton);
...
//		}
		...
		searchButton=(Button) findViewById(R.v3_item_search.searchbut);
...
//				Toast.makeText(getContext(),actionId+"", Toast.LENGTH_SHORT).show();
		...
		taoicon.setOnClickListener( new OnClickListener() {
			@Override
			public void onClick(View v) {
