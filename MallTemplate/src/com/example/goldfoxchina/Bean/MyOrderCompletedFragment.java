...
public class MyOrderCompletedFragment extends Fragment {
    ...
    public MyOrderCompletedFragment(ArrayList<HashMap<String,Object>> getArrayList){
        this.getArrayList = getArrayList;
    }
    public MyOrderCompletedFragment(){
    ...
    class getSellerWaitingOrderList extends AsyncTask<Void, ArrayList<HashMap<String, Object>>, ArrayList<HashMap<String, Object>>> {
        ...
        protected ArrayList<HashMap<String, Object>> doInBackground(Void... voids) {
            try {
                ...
                if (!"".equals(shopId)) {
                    getArrayList = GetJsonData.myBuyGoodsOrderListJsonData(context, "0", "10", "END");
                    Log.d("shopId", shopId + "");
                } else {
