...
public class SystemCoreSoftAdapter extends BaseAdapter{
	...
	public SystemCoreSoftAdapter(Context context, List<InstalledApkInfoItem> data){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=mInflater.inflate(R.layout.listview_systemcoresoftfragment,null);
