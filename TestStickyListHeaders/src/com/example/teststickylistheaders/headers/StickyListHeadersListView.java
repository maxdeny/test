package com.example.teststickylistheaders.headers;
...
import com.example.teststickylistheaders.R;
import com.example.teststickylistheaders.headers.WrapperViewList.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public interface OnHeaderClickListener {
        void onHeaderClick(StickyListHeadersListView l, View header, int itemPosition, long headerId,
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mPaddingLeft = a.getDimensionPixelSize(R.styleable.StickyListHeadersListView_android_paddingLeft,
                        padding);
                ...
                mPaddingRight = a.getDimensionPixelSize(R.styleable.StickyListHeadersListView_android_paddingRight,
                        padding);
                mPaddingBottom = a.getDimensionPixelSize(R.styleable.StickyListHeadersListView_android_paddingBottom,
                        padding);
                ...
                mList.setDrawSelectorOnTop(a.getBoolean(R.styleable.StickyListHeadersListView_android_drawSelectorOnTop,
                        false));
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.setFastScrollAlwaysVisible(a.getBoolean(R.styleable.StickyListHeadersListView_android_fastScrollAlwaysVisible,
                ...
                mIsDrawingListUnderStickyHeader = a.getBoolean(R.styleable.StickyListHeadersListView_isDrawingListUnderStickyHeader,
                        true);
            }
            finally {
                a.recycle();
    ...
    private void updateHeader(int headerPosition) {
        ...
        if (mHeaderPosition == null || mHeaderPosition != headerPosition) {
            ...
            Log.v("zhuolei", "mHeadId:" + mHeaderId + "headerId get from adater:" + headerId);
        ...
        if (mOnHeaderClickListener != null) {
            mHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnHeaderClickListener.onHeaderClick(StickyListHeadersListView.this,
                            mHeader,
                            mHeaderPosition,
                            mHeaderId,
                            true);
